  ...
  <div class="site-container">
    ...
    <div v-else>
      <div class="md:text-center text-sm">
        <p>
          Works, Careers の閲覧には顧客情報が含まれており ログインが必要です
        </p>
        <p class="mt-2">
          ログインアカウントは記録させて頂いております
        </p>
      </div>
      <!--
      ...
      -->
      <div class="flex justify-center mt-4" v-if="currentTabName == 'google'">
        <button type="button" @click="googleLogin" class="text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
